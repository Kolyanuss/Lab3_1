/*
Скрипт развертывания для SKILLdbTEST
...
GO
:setvar DatabaseName "SKILLdbTEST"
:setvar DefaultFilePrefix "SKILLdbTEST"
...
GO
PRINT N'Идет создание Таблица [dbo].[Employees]…';
...
GO
PRINT N'Идет создание Таблица [dbo].[Employees_Skills]…';
...
GO
PRINT N'Идет создание Таблица [dbo].[Scores]…';
...
GO
PRINT N'Идет создание Таблица [dbo].[Skills]…';
...
GO
PRINT N'Идет создание Таблица [dbo].[Users_Roles]…';
...
GO
PRINT N'Идет создание Ограничение по умолчанию [dbo].[DF_Employees_IsActive]…';
...
GO
PRINT N'Идет создание Ограничение по умолчанию [dbo].[DF_Employees_DateCreated]…';
...
GO
PRINT N'Идет создание Ограничение по умолчанию [dbo].[DF_Roles_DateCreated]…';
...
GO
PRINT N'Идет создание Ограничение по умолчанию [dbo].[DF_Users_IsAdmin]…';
...
GO
PRINT N'Идет создание Ограничение по умолчанию [dbo].[DF_Users_DateCreated]…';
...
GO
PRINT N'Идет создание Процедура [dbo].[SP_DeleteRecordFromTable]…';
...
END
GO
PRINT N'Идет создание Процедура [dbo].[SP_GetAllEmployeeSkillsByEmployeeId]…';
...
END
GO
PRINT N'Идет создание Процедура [dbo].[SP_GetAllRecordsFromTable]…';
...
END
GO
PRINT N'Идет создание Процедура [dbo].[SP_GetRecordByIdFromTable]…';
...
END
GO
PRINT N'Идет создание Процедура [dbo].[SP_InsertRecordToTable]…';
...
END
GO
PRINT N'Идет создание Процедура [dbo].[SP_UnActivateRecordInTable]…';
...
END
GO
PRINT N'Идет создание Процедура [dbo].[SP_UpdateRecordInTable]…';
